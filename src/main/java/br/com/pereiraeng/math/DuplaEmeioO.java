 ...
 *
 */
public class DuplaEmeioO<O> extends DuplaO<O> {
	...
	public DuplaEmeioO(O i1, O i2, O i3) {
		super(i1, i2);
		this.set3(i3);
	}

	public DuplaEmeioO(DuplaO<O> d, O i3) {
		this(d.get1(), d.get2(), i3);
	}

	public DuplaEmeioO(O[] is) {
		this(is[0], is[1], is[2]);
	}
	...
	public void set3(O i3) {
		this.i3 = i3;
	}

	public DuplaO<O> getDupla() {
		return new DuplaO<>(get1(), get2());
	}
	...
	public boolean equals(Object anObject) {
		if (this == anObject)
			return true;
		if (anObject instanceof DuplaEmeioO) {
			DuplaEmeioO<?> duplaEmeio = (DuplaEmeioO<?>) anObject;
	...
	@Override
	public int hashCode() {
		return super.hashCode() + i3.hashCode();
	}

	@Override
	public String toString() {
		return "(" + super.toString() + ";" + i3.toString() + ")";
	}
