...
/**
 * Classe do objeto que representa um <strong>conjunto</strong> com dois inteiros.
...
public class Dupla {
	...
	public boolean contains(Dupla d) {
	...
	public boolean equals(Object anObject) {
		if (this == anObject)
			return true;
		if (anObject instanceof Dupla) {
			Dupla dupla = (Dupla) anObject;
